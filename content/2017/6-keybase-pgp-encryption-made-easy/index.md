...
[![keybase identity](keybase_identity.png){ width=100% }](keybase_identity.png)
...
[![keybase chris folder](keybase_chris_folder.png){ width=60% }](keybase_chris_folder.png)
...
Every user initially had 10GB quota available, but a few hints (including one of their [recent screenshots](teams-splash-announcement.png))
...
[![kybase chat](keybase_chat.png){ width=100% }](keybase_chat.png)
...
[![teams announcement](teams-splash-announcement.png){ width=100% }](teams-splash-announcement.png)
...
[![keybase git](keybase_git.png){ width=100% }](keybase_git.png)
